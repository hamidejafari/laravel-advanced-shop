...
class ShopController extends Controller
{
    ...
    public function checkout()
    {
        ...
        if ($user){
            ...
            $default_address = Address::authUser()->orderby('default_address', 'DESC')->orderby('id', 'DESC')->first();
        }
        else{
            $addresses = null;
...
//        }
    ...
    public function postCheckout(Request $request)
    {
        ...
        $default_address = Address::authUser()->first();
        ...
        if($request->get('post_type') == 4){
            if($default_address->city_id == 246 && @$currentOrder->total_prices > 500000){
                $post_price = 0;
            }else{
                $post_price = 8000;
            }
