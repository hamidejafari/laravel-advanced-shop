...
class VueController2 extends Controller
{
    ...
    public function productList(Request $request){
        ...
        $products = Product::whereIn('id',$cat_pro)->where('not_found','0')->get()->sortByDesc('stockCount');
...
//        return response()->json(['products' => $product_array->toArray()], 200);
    ...
    public function brandList(Request $request){
        $req = $request->all();
        $products = Product::where('brand_id',$req['brand_id'])->where('not_found','0')->get()->sortByDesc('stockCount');
