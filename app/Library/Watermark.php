...
class Watermark
{
    ...
    function insert_watermark($min_image = '', $logo)
    {
        global $config;
        $margin = 7;

        // $this->watermark_image_light = 'watermark/watermark_light.png';
        $this->watermark_image_light = $logo;
        $this->watermark_image_dark = $logo;
