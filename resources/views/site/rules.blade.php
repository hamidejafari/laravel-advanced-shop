...
@section('title'){{'قوانین و مقررات فروشگاه اینترنتی و آنلاین کاج شاپ | کاج شاپ'}} @stop
@section('description')
{{'قوانین و مقررات فروشگاه اینترنتی و آنلاین کاج شاپ شامل تعریف مشتری یا کاربر، تعریف سفارش، تعریف روز کاری و سایر موارد را می‌توانید در سایت کاج شاپ مشاهده کنید.'}}
@stop
@section('content')
