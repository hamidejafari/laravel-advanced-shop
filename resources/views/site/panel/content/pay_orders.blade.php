			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center text-secondary">
							{!! $pay_order->order_date !!}
						</td>
						<td class="text-center text-secondary">
							{{number_format(@$pay_order->payment)}}
						</td>
						<td class="text-center text-secondary">
							{{number_format(@$pay_order->total_prices)}}
						</td>
						<td class="text-center text-secondary">
							{{@$pay_order->orderstatus->title}}
						</td>
						<td class="text-center text-secondary">
							<a href="{{route('panel.order.details',['id'=>$pay_order->id])}}"
