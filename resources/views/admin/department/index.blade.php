        ...
        <div class="row w-100 m-0">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
                ...
                <div class="card" id="app34534567">
                    ...
                    <div class="card-body">
                        <form method="post"
                              action="{{URL::action('Admin\DepartmentController@postAdd')}}"
        ...
        <div class="row w-100 m-0">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
                <div class="card">
                    ...
                    <form method="post" action="{{URL::action('Admin\DepartmentController@postDelete')}}">
                        {{ csrf_field() }}
                        <div class="py-3 px-2">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{URL::action('Admin\DepartmentController@postEdit',$row->id)}}">
                            {{ csrf_field() }}
