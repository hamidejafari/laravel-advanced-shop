...
<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
        <div class="card col-lg-8">
            <div class="row w-100 m-0">
		<form method="post" action="{{url('/admin/box/delete')}}" style="float: left">
			{{ csrf_field() }}
			<div class="px-2 py-3">
				...
				<a href="{{URL::action('Admin\BoxController@getAdd' , $id)}}" type="button" class="btn btn-space btn-primary">
                    	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td>
															<a href="{{URL::action('Admin\BoxController@getEdit',$question->id)}}"
																type="button"
                    ...
                    $(function () {
                        $("#list ul").sortable({
                            opacity: 0.8, cursor: 'move', update: function () {
                                ...
                                $.post("{!!URL::action('Admin\BoxController@postSort')!!} ", order, function (theResponse) {
