...
<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
		...
		<form method="post" action="{{url('/admin/mobile-slider/delete')}}">
			{{ csrf_field() }}
			<div class="py-3 px-2">
				...
				<a href="{{url('admin/mobile-slider/add')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td class="sorting_1">@if($row->content_type == 8)
                                                                بنرهای اول موبایل
                                                            @elseif($row->content_type == 9)
                                                                بنرهای دوم موبایل
                                                            @elseif($row->content_type == 10)
                                                                اسلایدر موبایل
                                                            @elseif($row->content_type == 11)
                                                                بنرهای انتهایی موبایل
                                                            @endif
    ...
    <div class="col-lg-4">
        <div id="list">
            ...
            <ul>
                ...
                <div class="alert alert-primary alert-dismissable rounded-lg" style="direction: rtl; margin: 0px auto;">
                    <i class="fa fa-arrow-circle-down"></i>
                    <span style="font-size: 10px;">ترتیب اسلایدر موبایل </span>
                </div>
                @foreach($categorySort7 as $rowSort5)
                ...
                <div class="alert alert-primary alert-dismissable rounded-lg" style="direction: rtl; margin: 0px auto;">
                    <i class="fa fa-arrow-circle-down"></i>
                    <span style="font-size: 10px;">ترتیب بنرهای انتهایی موبایل </span>
                </div>
                @foreach($categorySort8 as $rowSort6)

                    <li class="list-unstyled  my-2 p-3 shadow-sm rounded-lg" id="arrayorder_{!! stripslashes($rowSort6['id']) !!}"  style="background-color: #3b3f54" >{!! stripslashes($rowSort6['title']) !!}
                        <div class="clear"></div>
                    </li>
